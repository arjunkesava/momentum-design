export const featureCards = [
  ...
  },
  {
    ...
    description: `Use your favorite AI tools like Cursor to prototype ideas with real code; 
    testing flows and bringing concepts to life.`,
    linkText: 'Get the starter kit',
    linkUrl: 'https://github.com/momentum-design/starter-react',
    newTab: true,
  },
  {
    title: 'Design tokens',
  ...
  },
  {
    ...
    linkText: 'View icons',
    linkUrl: '/en/tokens/icons/',
  },
  {
    title: 'Illustrations',
    description: 'We offer a collection of custom illustrations that bring warmth and clarity to product experiences.',
    linkText: 'View illustrations',
